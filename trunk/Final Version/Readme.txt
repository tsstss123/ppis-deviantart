setup.m can be used to add external packages to the Matlab path

Classification - Directory contains Matlab classifier code.
Data_Collection - Directory contains Python data collection scripts.
