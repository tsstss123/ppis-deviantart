...
public class Footer extends JPanel {
	...
	private void initLayout() {
		try {
			bg = ImageIO.read(new File("data/img/footer.png"));
		} catch (IOException e) {
			e.printStackTrace();			
		}
		...
		ImageIcon ii	= new ImageIcon("data/img/buttons/features.png");
		...
		ii	= new ImageIcon("data/img/buttons/class_labels.png");
		label	= new JLabel(ii);
		label.setPreferredSize(new Dimension(112, 31));
		label.setCursor(deviantART.hander);
