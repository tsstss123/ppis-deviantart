...
autoselect=[1,1,1,1,1];
optimalselect=[1,2,3,4,5];
   ...
   for j=1:length(artistnames)
       if (i==j)
           ...
           for k=1:length(optimalselect)
                ...
                savefile1=['ConfusionMatrixOutput3', filesep, 'confmatrix_', int2str(i),'_', int2str(j), '_', int2str(k)];
                savefile2=['ConfusionMatrixOutput3', filesep, 'conffeaturematrix_', int2str(i),'_', int2str(j), '_', int2str(k)];
