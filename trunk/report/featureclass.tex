...
\begin{figure}[!h]
  \begin{center}
    \subfigure[Original image]{\label{centersample}\includegraphics[scale=0.22]{img/originalFlower}}
     \subfigure[Edges]{\label{lssample}\includegraphics[scale=0.22]{img/edgesFlower}} 
     ...
     \subfigure[3x3 grid for compositional edge-pixel ratio]{\label{gridExample}\includegraphics[scale=0.22]{img/gridEdgesFlower}}
...
%\begin{figure}
%\label{gridImage}
%\caption{3x3 grid for compositional edge-pixel ratio}
%\begin{center}
...
\paragraph{\textit{Performance measures}}
