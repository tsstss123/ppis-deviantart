...
This is important to have the smallest set of features  as possible to describe a class.
...
In this research $\beta$=1 has been used, which means that the precision and recall are evenly weighted.
