...
For the image experiments we collected our dataset by downloading the complete galleries from 31 artists.
...
Some dataset statistics are listed in table \ref{datasetstats}.
...
\begin{table}[ht]
	...
	\subtable[General]{
		\begin{tabular} { |l|c| }
			...
			\hline
			Average image count per artist & 171 \\
			\hline
