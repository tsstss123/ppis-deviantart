...
It has been used the Itti's model \cite{Itti_model}} due to its low computentional time and the existense of a free toolkit \cite{link2model} made by Dirk Walther.
