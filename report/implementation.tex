...
the image data. The \textit{gallery scraper} is implemented in python and uses
built-in libraries to parse the XML files. For each image general information is 
