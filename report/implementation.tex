...
This visualization is not used to visualize the dataset, but to display the performance of the classification.
The circle is split into the regions (purple: artists or categories, yellow: features, green: classifiers), each of them representing a variables that play an important role in the classification of images.
